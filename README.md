...
<table>
    ...
    <tr>
        <td width="50%">
            <img
                src="public/preview/mobile-lists.png"
                alt="Todo List mobile lists preview"
                width="100%"
            >
        </td>
        <td width="50%">
            <img
                src="public/preview/mobile-tasks.png"
                alt="Todo List mobile tasks preview"
                width="100%"
            >
        </td>
    </tr>
